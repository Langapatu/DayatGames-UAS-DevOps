...
@section('content')
    ...
    <article>
        <section class="relative isolate overflow-hidden rounded-3xl border border-slate-800 bg-slate-950">
            <img src="{{ $game->heroUrl() }}" alt="" class="absolute inset-0 -z-20 h-full w-full object-cover opacity-30">
            ...
            <div class="grid items-end gap-8 px-6 py-12 md:grid-cols-[280px_1fr] md:px-10 md:py-16">
                <img src="{{ $game->coverUrl() }}" alt="Cover {{ $game->title }}" class="game-image-contain game-detail-poster w-full rounded-2xl shadow-2xl">
                <div>
